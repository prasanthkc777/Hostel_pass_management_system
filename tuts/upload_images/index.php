...
<div style="background-color:#616161;  padding:20px;" ><h4 style="color:white;"><a style="text-decoration:none; color:white;" href=" ../homepage2.php?application_number= <?php echo $apn; ?>  " ><i class="fa fa-arrow-circle-left"></i> Back &nbsp; &nbsp; </a> Hostel Pass </h4> </div>
...
<a class="text-muted" style="display:none" href="view.php?tname=<?php echo $tname ?>" >view</a>
   ...
   // <!-- Modal content-->
    <div class='modal-content'>
      ...
      <div class='modal-body'>
        <a href='delete.php?application_number= $apn & id=$id & tname= $tname ' class='btn btn-danger' style='margin-left:250px'>Delete</a>
      </div>
...
?>
 <!-- profile modal end --><!-- profile modal end --><!-- profile modal end -->
  ...
  <hr>
		...
		<thead>
		<button style="padding:5px;" class="btn btn-primary" type="button" data-toggle="modal" data-target="#myModal">
...
<div class="modal-dialog">
  ...
  <div class="modal-content">
	...
	<div class="modal-body">
	  <form action="add.php?application_number= <?php echo  $apn;?>  & tname= <?php echo  $_GET['tname'];?> " method="POST" enctype="multipart/form-data">
		  
		  <!-- This is test for New Card Activate Form  -->
		  <!-- This is Address with email id  -->
<div class="form-row">
<div class="form-group col-md-6">
<label for="inputEmail4">Student application/Id no.</label>
<input type="text" class="form-control" name="card_no" placeholder="Enter Studentapplication/Id no." maxlength="15" required>
</div>
<div class="form-group col-md-6">
...
<input type="text" class="form-control" name="year" placeholder="type fourth or third or second or first ">
</div>
<div class="form-row">
<div class="form-group col-md-6">
<label for="section">section</label>
<input type="text" class="form-control" name="section" placeholder="type a or b or c or d or other ">
</div>
...
<div class="form-group col-md-6">
<label for="aadharno">parent's mobile No.</label>
...
<div id='edit$id' class='modal fade' role='dialog'>
  <div class='modal-dialog'>
    ...
    <div class='modal-content'>
      ...
      <div class='modal-body'>
        <form action='edit.php?application_number= $apn & id=$id & tname= $tname' method='post' enctype='multipart/form-data'>
...
<div class='form-group col-md-6'>
<label for='year'>year</label>
<input type='text' class='form-control' name='year' placeholder='type fourth or third or second or first '  value='$year'>
</div>
<div class='form-row'>
<div class='form-group col-md-6'>
<label for='section'>section</label>
<input type='text' class='form-control' name='section' placeholder='type a or b or c or d or other '  value='$section'>
</div>
		...
		<div class='form-group col-md-6'>
		<label for='aadharno'>parents mobile number.</label>
